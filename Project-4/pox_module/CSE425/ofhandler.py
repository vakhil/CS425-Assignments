...
class OFHandler (EventMixin):
  ...
  def _handle_PacketIn (self, event):
    ...
    pkt = event.parse()
    raw_packet = pkt.raw
    core.CSE425_ofhandler.raiseEvent(SRPacketIn(raw_packet, event.port))
...
class CSE425_ofhandler (EventMixin):
  """
...
def launch (transparent=False):
  ...
  """    
  core.registerNew(CSE425_ofhandler, str_to_bool(transparent))
