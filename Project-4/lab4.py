...
"""
Start up a Simple topology for CSE425
"""
...
class CSE425Topo( Topo ):
    "CSE 425 Lab 3 Topology"
...
class CSE425Controller( Controller ):
    "Controller for CSE425 Multiple IP Bridge"
...
def CSE425net():
    stophttp()
    "Create a simple network for CSE425"
    r = get_ip_setting()
    if r == -1:
